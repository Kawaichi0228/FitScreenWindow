...
class Ui_ConfigGUI(object):
    def setupUi(self, ConfigGUI):
        ...
        ConfigGUI.resize(940, 592)
        ConfigGUI.setMinimumSize(QSize(940, 560))
        ...
        self.entireStyleSheet.setStyleSheet(u"QWidget{\n"
...
"#titleLeftDescription { font: 8pt \"Segoe UI\"; color: #FF5F5F; }\n"
"\n"
"/* MENUS */\n"
...
"\n"
"/* Top Buttons */\n"
"#rightButtonsFrame .QPushButton { background-color: rgba(255, 255, 255, 0); border: none;  border-radiu"
                        "s: 5px; }\n"
...
"    bac"
                        "kground-image: url(:/images/icon-arrowbottom.png);\n"
...
"")
        ...
        self.entireBg.setGeometry(QRect(10, 10, 920, 549))
        ...
        self.leftTitleApp.setGeometry(QRect(19, 10, 151, 31))
        font1 = QFont()
        ...
        self.leftTitleApp.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
